<%@ include file="jsp/header.jsp"%>
  <section class="cake-form">
        ...
        <form action="#" method="POST" class="cake-form-container" id="cakeForm" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="cake-image" class="cake-label">Upload Sample Cake Image:</label>
                <input type="file" name="cake-image" id="cake-image" class="form-control" accept="image/*" required>
            </div>
            <div class="form-group">
